...
| 日期 | 版本 | 变更内容 |
|------|------|----------|
| 2026-01-30 | v2.1.0 | 移除 Gateway，简化为独立后端服务架构 |
...
### v2.1.0 - 简化架构（2026-01-30）

#### 架构调整

**从微服务到独立服务**：
- **v2.0 架构**：Gateway + 后端服务微服务架构
- **v2.1 架构**：独立后端服务（更简单、更直接）
...
系统采用**独立服务架构**，支持命令行工具和 FastAPI 两种使用方式：
